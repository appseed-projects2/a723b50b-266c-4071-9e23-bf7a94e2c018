...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-28 02:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a723b50b-266c-4071-9e23-bf7a94e2c018.git
$ cd a723b50b-266c-4071-9e23-bf7a94e2c018
```
